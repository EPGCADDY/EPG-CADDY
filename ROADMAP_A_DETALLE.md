...
- V407-R24: la actualización forzada conserva `__gscg_build_check`, carga el shell nuevo fuera del worker antiguo y promueve explícitamente la caché R24 antes de limpiar la URL; evita volver a R18.
