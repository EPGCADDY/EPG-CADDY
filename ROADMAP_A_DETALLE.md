...
- Visor Support estable: `manual.html` conserva índice, búsqueda, PLAY/STOP, velocidad, zoom y anterior/siguiente, pero mantiene en memoria una sola página 2160×4320 y precarga la siguiente antes de sustituirla. Se elimina el `IntersectionObserver` que podía mover la página al desplazarse. `test-v311-manual-hosting.mjs` exige una sola `.manual-page`, precarga explícita y ausencia del observador.
