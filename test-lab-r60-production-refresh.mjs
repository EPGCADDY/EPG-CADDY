...
assert.match(app,/gscg-release" content="PRODUCTION-20260923-R67"/,'La app debe identificarse como R67');
...
assert.match(sw,/const RELEASE="PRODUCTION-20260923-R67"/,'El SW debe identificarse como R67');
...
console.log('PASS R67: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
