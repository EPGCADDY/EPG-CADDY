...
assert.match(app,/gscg-release" content="PRODUCTION-20260924-R105"/,'La app debe identificarse como R101');
...
assert.match(sw,/const RELEASE="PRODUCTION-20260924-R105"/,'El SW debe identificarse como R101');
