...
assert.match(app,/gscg-release" content="LABORATORIO-20260925-R135"/,'La app debe identificarse como R135');
...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R135"/,'El SW debe identificarse como R135');
...
console.log('PASS R135: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
