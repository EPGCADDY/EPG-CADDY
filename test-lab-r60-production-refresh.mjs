...
assert.match(app,/gscg-release" content="LABORATORIO-20260925-R114"/,'La app debe identificarse como R114');
...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R114"/,'El SW debe identificarse como R114');
...
console.log('PASS R114: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
