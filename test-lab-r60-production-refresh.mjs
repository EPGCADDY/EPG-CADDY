...
assert.match(app,/gscg-release" content="LABORATORIO-20260925-R145"/,'La app debe identificarse como R145');
...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R145"/,'El SW debe identificarse como R145');
...
console.log('PASS R145: network-first fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
