...
assert.match(app,/gscg-release" content="LAB-20260923-R101"/,'La app debe identificarse como R101');
...
assert.match(sw,/const RELEASE="LAB-20260923-R101"/,'El SW debe identificarse como R101');
