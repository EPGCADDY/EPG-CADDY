...
assert.match(app,/gscg-release" content="LABORATORIO-20260925-R111"/,'La app debe identificarse como R109');
...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R111"/,'El SW debe identificarse como R109');
