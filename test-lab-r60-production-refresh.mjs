...
assert.match(app,/gscg-release" content="LAB-PRODUCTION-REFRESH-20260923-R62"/,'La app debe identificarse como R62');
...
assert.match(sw,/const RELEASE="LAB-PRODUCTION-REFRESH-20260923-R62"/,'El SW debe identificarse como R62');
...
console.log('PASS R62: producción fuerza actualización de clientes PWA viejos y evita permanecer en R43/R59');
