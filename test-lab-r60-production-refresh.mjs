...
assert.match(app,/gscg-release" content="PRODUCTION-20260923-R72"/,'La app debe identificarse como R72');
...
assert.match(sw,/const RELEASE="PRODUCTION-20260923-R72"/,'El SW debe identificarse como R72');
...
console.log('PASS R72: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
