...
assert.match(app,/gscg-release" content="LABORATORIO-20260925-R136"/,'La app debe identificarse como R136');
...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R136"/,'El SW debe identificarse como R136');
...
console.log('PASS R136: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
