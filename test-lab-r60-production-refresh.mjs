...
assert.match(app,/gscg-release" content="LABORATORIO-20260925-R144"/,'La app debe identificarse como R144');
...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R144"/,'El SW debe identificarse como R144');
...
console.log('PASS R144: network-first fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
