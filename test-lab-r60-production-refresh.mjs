...
assert.match(app,/gscg-release" content="PRODUCTION-20260923-R71"/,'La app debe identificarse como R71');
...
assert.match(sw,/const RELEASE="PRODUCTION-20260923-R71"/,'El SW debe identificarse como R71');
...
console.log('PASS R71: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
