...
assert.match(app,/gscg-release" content="PRODUCTION-20260923-R75"/,'La app debe identificarse como R74');
...
assert.match(sw,/const RELEASE="PRODUCTION-20260923-R75"/,'El SW debe identificarse como R74');
...
console.log('PASS R75: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
