...
assert.match(app,/gscg-release" content="PRODUCTION-20260923-R76"/,'La app debe identificarse como R76');
...
assert.match(sw,/const RELEASE="PRODUCTION-20260923-R76"/,'El SW debe identificarse como R76');
...
console.log('PASS R76: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
