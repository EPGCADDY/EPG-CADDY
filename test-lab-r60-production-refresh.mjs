...
assert.match(app,/gscg-release" content="LABORATORIO-20260925-R134"/,'La app debe identificarse como R134');
...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R134"/,'El SW debe identificarse como R134');
...
console.log('PASS R134: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
