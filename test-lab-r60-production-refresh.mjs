...
assert.match(app,/gscg-release" content="LABORATORIO-20260925-R132"/,'La app debe identificarse como R119');
...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R132"/,'El SW debe identificarse como R119');
...
console.log('PASS R119: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
