...
assert.match(app,/gscg-release" content="LABORATORIO-20260925-R117"/,'La app debe identificarse como R117');
...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R117"/,'El SW debe identificarse como R117');
...
console.log('PASS R117: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
