...
assert.match(app,/gscg-release" content="PRODUCTION-20260924-R106-H2"/,'La app debe identificarse como R101');
...
assert.match(sw,/const RELEASE="PRODUCTION-20260924-R106-H2"/,'El SW debe identificarse como R101');
...
console.log('PASS R101: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
