...
assert.match(app,/gscg-release" content="LABORATORIO-20260925-R112"/,'La app debe identificarse como R112');
...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R112"/,'El SW debe identificarse como R112');
...
console.log('PASS R112: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
