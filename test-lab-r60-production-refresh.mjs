...
assert.match(app,/gscg-release" content="LABORATORIO-20260925-R137"/,'La app debe identificarse como R137');
...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R137"/,'El SW debe identificarse como R137');
...
console.log('PASS R137: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
