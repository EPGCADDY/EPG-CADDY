...
assert.match(app,/gscg-release" content="LABORATORIO-20260925-R110"/,'La app debe identificarse como R109');
...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R110"/,'El SW debe identificarse como R109');
...
console.log('PASS R109: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
