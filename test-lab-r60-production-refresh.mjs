...
assert.match(app,/gscg-release" content="LABORATORIO-20260925-R146"/,'La app debe identificarse como R146');
...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R146"/,'El SW debe identificarse como R146');
...
console.log('PASS R146: network-first fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
