...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R118"/,'El SW debe identificarse como R118');
...
console.log('PASS R118: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
