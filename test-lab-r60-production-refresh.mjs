...
assert.match(app,/gscg-release" content="LABORATORIO-20260925-R115"/,'La app debe identificarse como R115');
...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R115"/,'El SW debe identificarse como R115');
...
console.log('PASS R115: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
