...
assert.match(app,/gscg-release" content="LABORATORIO-20260925-R140"/,'La app debe identificarse como R140');
...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R140"/,'El SW debe identificarse como R140');
...
console.log('PASS R140: network-first fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
