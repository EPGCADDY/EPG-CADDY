...
assert.match(app,/gscg-release" content="PRODUCTION-20260923-R70"/,'La app debe identificarse como R70');
...
assert.match(sw,/const RELEASE="PRODUCTION-20260923-R70"/,'El SW debe identificarse como R70');
...
console.log('PASS R70: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
