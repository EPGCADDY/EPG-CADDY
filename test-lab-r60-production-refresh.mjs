...
assert.match(app,/gscg-release" content="PRODUCTION-20260924-R106-H3"/,'La app debe identificarse como R106-H3');
...
assert.match(sw,/const RELEASE="PRODUCTION-20260924-R106-H3"/,'El SW debe identificarse como R106-H3');
