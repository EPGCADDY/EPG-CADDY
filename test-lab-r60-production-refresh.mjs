...
assert.match(app,/gscg-release" content="LABORATORIO-20260925-R141"/,'La app debe identificarse como R141');
...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R141"/,'El SW debe identificarse como R141');
...
console.log('PASS R141: network-first fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
