...
assert.match(app,/gscg-release" content="LABORATORIO-20260925-R113"/,'La app debe identificarse como R113');
...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R113"/,'El SW debe identificarse como R113');
...
console.log('PASS R113: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
