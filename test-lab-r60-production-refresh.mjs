...
assert.match(app,/gscg-release" content="LABORATORIO-20260925-R120"/,'La app debe identificarse como R119');
...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R120"/,'El SW debe identificarse como R119');
