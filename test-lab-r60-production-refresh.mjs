...
assert.match(app,/gscg-release" content="PRODUCTION-20260923-R77"/,'La app debe identificarse como R77');
...
assert.match(sw,/const RELEASE="PRODUCTION-20260923-R77"/,'El SW debe identificarse como R77');
...
console.log('PASS R77: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
