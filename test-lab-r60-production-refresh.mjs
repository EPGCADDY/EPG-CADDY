...
assert.match(app,/gscg-release" content="LABORATORIO-20260925-R107-H4"/,'La app debe identificarse como R106-H3');
...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R107-H4"/,'El SW debe identificarse como R106-H3');
...
console.log('PASS R106-H3: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
