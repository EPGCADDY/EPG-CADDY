...
assert.match(app,/gscg-release" content="PRODUCTION-20260923-R80"/,'La app debe identificarse como R80');
...
assert.match(sw,/const RELEASE="PRODUCTION-20260923-R80"/,'El SW debe identificarse como R80');
...
console.log('PASS R80: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
