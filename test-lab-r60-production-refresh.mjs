...
assert.match(app,/gscg-release" content="LABORATORIO-20260925-R108"/,'La app debe identificarse como R108');
...
assert.match(sw,/const RELEASE="LABORATORIO-20260925-R108"/,'El SW debe identificarse como R108');
...
console.log('PASS R108: producción fuerza actualización de clientes PWA viejos y evita permanecer en versiones anteriores');
