...
assert.match(app,/gscg-release" content="LAB-PRODUCTION-REFRESH-20260923-R61"/,'La app debe identificarse como R61');
...
assert.match(sw,/const RELEASE="LAB-PRODUCTION-REFRESH-20260923-R61"/,'El SW debe identificarse como R61');
...
console.log('PASS R61: producción fuerza actualización de clientes PWA viejos y evita permanecer en R43/R59');
