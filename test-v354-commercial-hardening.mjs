...
assert.match(readFileSync("index-grupal.html", "utf8"), /V354-COMMERCIAL-P0-HARDENING-20260828/);
assert.match(readFileSync("service-worker.js", "utf8"), /gscg-mobile-v354-commercial-p0/);
