...
assert.match(processSource,/submitAiUniversalText\(clean,\{voiceOnly:true\}\)/);
...
console.log("PASS V354/V367 VOZ: un jugador registra 3 hoyos, plural aceptado, consulta general sólo audible y telemetría privada");
