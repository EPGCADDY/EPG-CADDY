...
- Reedición Support: `docs/manual/v311/manual-pages-17-35.json` aclara registro opcional de uno a seis jugadores, alternativa manual ante voz no reconocida y corrección puntual de scores. `scripts/rebuild-manual-bets-live-data.py` evita PNG optimizados truncados; se regeneran `page-19.png`, `page-20.png`, `page-21.png` y ambos PDF de 74 páginas. `test-v311-manual-semantic-coverage.mjs` bloquea la pérdida futura de esas explicaciones.
