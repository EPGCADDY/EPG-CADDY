...
Refinamiento V397 de Historial: las rondas se mantienen ordenadas por `playedAt`, con búsqueda por fecha ISO, numérica o visible en español y hasta ocho resultados por página. Un doble toque sobre una ronda abre su Score Card Global original; debajo queda una sola acción, `ENVIAR TARJETA DIGITAL`, que comparte el PNG mediante la hoja nativa del dispositivo para seleccionar WhatsApp. Los ocho controles anteriores se retiran y el Historial oculta los lanzadores flotantes para dejar `ATRÁS` libre. La cuenta recuerda nombre/correo al escribir y permite mostrar u ocultar la contraseña sin guardarla. Producción permanece intacta.
