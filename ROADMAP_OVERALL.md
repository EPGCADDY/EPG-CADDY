...
Archivos exactos: `index-grupal.html`, `service-worker.js`, `test-v365-active-round-empty-recovery.mjs`, `test-v363-intocables-behavior.mjs`, `test-v357-ios-voice-transport-recovery.mjs`, `test-v361-synchronized-voice.mjs`, `test-v289-stableford-new-round-empty.mjs`, `test-v267-one-operational-line.mjs`, `test-v252-stableford-persistence-category-course.mjs`, `test-v260-round-points-player-return.mjs`, `Intocables/README.md`, `Intocables/intocables-gate.mjs`, `audit-project.mjs`, `package.json`, `CONTROL_PROYECTO_SCIRE/03_CASOS_TERMINADOS_Y_EVIDENCIA/V365_RECUPERACION_RONDA_ACTIVA/REPORTE_V365_RC036.md`, registro RC-036, cola, matriz de pendientes, mapa maestro, ambos ROADMAPS, reconstrucción PDF e inventario. Producción permanece intacta hasta PASS automático, Preview READY, verificación externa y reapertura física iPhone.

## V366 · entrada principal obligatoria sin ronda · 28 de agosto de 2026

La evidencia física `IMG_2193.png` rechaza el Preview V365: el enlace mostró `RONDA EN CURSO`, El Pulté y una matriz sin jugadores en vez de la pantalla principal `Inicio`. V365 protegía la selección de datos, pero no convertía la entrada visual sin ronda en un estado obligatorio durante todo el ciclo de Safari.

V366 incorpora `ensurePrincipalEntry()`: sin ronda recuperable, monta y fija `Inicio` en arranque, regreso desde segundo plano, `pageshow` y foco; si `Inicio` ya está visible no reinicia el Registro. Una tarjeta operativa con uno a seis jugadores conserva prioridad y no es cubierta. La entrada principal se monta antes de cualquier sincronización opcional.

Archivos exactos: `index-grupal.html`, `service-worker.js`, `test-v366-principal-entry-recovery.mjs`, `test-v365-active-round-empty-recovery.mjs`, `test-v358-active-round-reopen.mjs`, `test-v357-synchronized-progressive-voice.mjs`, `test-v311-neutral-match-home-link.mjs`, `Intocables/README.md`, `Intocables/intocables-gate.mjs`, `audit-project.mjs`, `package.json`, `CONTROL_PROYECTO_SCIRE/03_CASOS_TERMINADOS_Y_EVIDENCIA/V366_ENTRADA_PRINCIPAL/REPORTE_V366_RC037.md`, registro RC-037, cola, matriz de pendientes, mapa maestro, ambos ROADMAPS, reconstrucción PDF e inventario. Producción permanece intacta; Preview y prueba física Safari/iPhone son puertas separadas.
