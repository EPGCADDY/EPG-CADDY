...
## V354 · TRÁFICO Y CLIMA EN HORIZONTES REALES · 28 de agosto de 2026

V354 corrige RC-024. La consulta directa de tráfico ahora convierte expresiones naturales en hora `America/Guatemala`, envía realmente `departureTime` a Google Maps Routes y distingue una medición inmediata de una predicción futura. Cubre 30 minutos, una hora, tres horas, mañana con hora, próxima semana y fecha/hora ISO; cuando falta hora en un día futuro usa la misma hora local y lo declara.

El clima deja de responder con la observación actual a una solicitud futura. Los horizontes de 30 min, 1 h y 3 h eligen la primera hora disponible de Open-Meteo igual o posterior a la solicitada y muestran que la resolución es de 60 minutos. Mañana, próxima semana y fecha concreta generan pronóstico; fuera de las 16 jornadas disponibles se informa el rango real y no se inventa ni recicla el clima actual.

Banco y Preview PASS: tres rutas vehiculares —El Pulté → Pradera Concepción, Guatemala Country Club → Alta Vista y Mayan Golf → El Pulté— verifican ahora, 30 min, 1 h, 3 h, mañana y próxima semana. Clima cubre observación, 30 min, 1 h, 3 h, mañana, próxima semana y fecha fuera de rango. Se conservan ambigüedad segura, privacidad de GPS, proveedor, ETA, demora, distancia, hora de cálculo y compatibilidad LIVE V352/V353.

Preview `dpl_CmY7PwFGeLg797SFGL3ubNwwT2gr` READY, commit `8a4552b95214ffc8498742a41480bc887ddb04e8`, build exacto V354 y auditoría maestra 96/96. E2E remoto: seis escenarios vehiculares y siete climáticos PASS; observabilidad 13×`200`, cero `error`/`fatal`; navegador confirmó título, build, interfaz visible y cero error propio de la aplicación. Comparación simultánea Google Maps UI: 34 vs 35 min y 15.0 vs 14.9 km; 55 vs 55 min y 30.1 vs 30.1 km; 65 vs 65 min y 38.7 vs 38.7 km. AccuWeather y meteoblue confirmaron la tendencia de temperatura/lluvia para mañana y próxima semana; la dispersión entre modelos quedó visible, no forzada. Waze web no completó ETA por reCAPTCHA, por lo que Waze/iPhone y campo físico permanecen como puertas reales. Producción sigue intacta en `0dc1ba7a62b6bd6aec92752c539ca641cf950e26`.
...
Reversión V354: retirar únicamente parser, metadatos, formato horario y banco V354; restaurar build/caché V353. No toca base de datos, scores ni Producción.
