...
assert.match(html,/V407-R10-ACTIVE-UPDATE-BUTTON-20260908/);
assert.match(worker,/v407-r10-active-update-button/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R10<\/span>/);
