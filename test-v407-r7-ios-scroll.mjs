...
assert.match(html,/V407-R17-EMPTY-ROWS-OK-20260908/);
assert.match(worker,/v407-r17-empty-rows-ok/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R17<\/span>/);
