...
assert.match(html,/V407-R13-UNIVERSALES-CATEGORIES-RED-20260908/);
assert.match(worker,/v407-r13-universales-categories-red/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R13<\/span>/);
