...
assert.match(html,/V407-R16-MODE-SELECTION-20260908/);
assert.match(worker,/v407-r16-mode-selection/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R16<\/span>/);
