...
assert.match(html,/V407-R9-MANUAL-UPDATE-20260908/);
assert.match(worker,/v407-r9-manual-update/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R9<\/span>/);
