...
assert.match(html,/V407-R14-PERSISTENT-MANUAL-UPDATE-20260908/);
assert.match(worker,/v407-r14-persistent-manual-update/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R14<\/span>/);
