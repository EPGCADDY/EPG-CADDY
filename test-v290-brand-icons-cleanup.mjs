...
assert.match(html,/class="newbie-guide-title">DICTA ASÍ:<\/div>\s*<div>NOMBRE · 14 · BLANCAS<\/div>\s*<div>NOMBRE · 21 · AZULES<\/div>\s*<div class="newbie-guide-player">HASTA 6 JUGADORES<\/div>\s*<div>LUEGO TOCA OK<\/div>/);
