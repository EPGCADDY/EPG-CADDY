...
const PUBLIC_PATHS=new Set([
  "/access.html","/live.html","/live-view.js","/match-play.js","/card-share.html","/card-artifacts.js","/favicon.ico",
  "/service-worker.js","/manifest.webmanifest","/manual.webmanifest","/api/release","/update-client-e.js","/app-current-shell.html"
]);
...
export default async function accessGate(request){
  ...
  if(path==="/api/card-share"&&request.method==="POST"){
    try{const body=await request.clone().json();if(String(body?.action||"").toLowerCase()==="read")return next()}catch{}
  }
