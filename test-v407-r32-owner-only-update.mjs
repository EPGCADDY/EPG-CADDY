...
assert.match(approved,/V407-R\d+[^\"]*/);
...
assert.match(updater,/worker\.postMessage\(\{type:"PROMOTE_BUILD",build:pendingPublishedBuild,nonce\},\[channel\.port2\]\)/);
...
console.log("PASS V407 R32 · base aprobada histórica conservada para transición R33");
