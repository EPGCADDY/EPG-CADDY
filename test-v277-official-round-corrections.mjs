...
assert.match(html,/GSCRoundClosure\.correct\(round,\{changes,reason,authorizedBy,appVersion:"V278"\}\)/);
...
assert.equal(masterSync.APP_VERSION,"V278");
...
const corrected=await globalThis.GSCRoundClosure.correct(closed,{changes:[{playerId:"p1",hole:1,gross:3}],reason:"SCORE VERIFICADO",authorizedBy:"JAIME",correctedAt:"2026-08-23T17:00:00Z",appVersion:"V278"});
