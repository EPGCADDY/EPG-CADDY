...
checks.splice(checks.indexOf('test-score-engine.mjs'),0,'test-v369-physical-voice-weather-traffic-recovery.mjs','test-v370-native-spanish-fast-close.mjs','test-v371-spanish-only-universal.mjs','test-v372-stableford-live-mirror.mjs');
