...
checks.splice(checks.indexOf('test-score-engine.mjs'),0,'test-r18-owner-guest-24h-access.mjs','test-invite-service-worker.mjs');
...
checks.splice(checks.indexOf('test-score-engine.mjs'),0,'test-ptt-independent-turns.mjs','test-r40-five-holes.mjs','test-r36-capture-release.mjs','test-r36-capture-permissions.mjs','test-r36-followup-events.mjs','test-r35-weather-location.mjs','test-r37-closed-round-live-weather.mjs');
