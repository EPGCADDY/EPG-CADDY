...
checks.splice(checks.indexOf('test-score-engine.mjs'),0,'test-r32-open-conversation.mjs','test-r33-visible-voice-errors.mjs','test-voice-result-integrity.mjs','test-r34-audio-response.mjs','test-r34-persistent-voice-regression.mjs','test-r34-universal-architecture.mjs');
