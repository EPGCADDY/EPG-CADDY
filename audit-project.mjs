...
checks.splice(checks.indexOf('test-score-engine.mjs'),0,'test-v406-r4-mobile-controls.mjs','test-v406-tournament-categories.mjs','test-v406-r5-simple-tournament-live.mjs');
