...
checks.splice(checks.indexOf('test-score-engine.mjs'),0,'test-v388-history-empty-round.mjs','test-v388-universal-three-turn-capture.mjs','test-v389-universal-runtime-availability.mjs','test-v390-physical-history-voice-recovery.mjs','test-v391-integrated-technical-lock.mjs');
