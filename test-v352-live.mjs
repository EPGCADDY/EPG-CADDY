...
assert.equal(clientSnapshot.appVersion,"V354");
...
assert.match(index,/V(?:354-COMMERCIAL-P0-HARDENING|355-MICROPHONE-ROUND-CONTINUITY)/);
...
assert.match(worker,/gscg-mobile-v(?:354-commercial-p0|355-microphone-round-continuity)/);
