...
// LAB R127 final visual/format contract
{
 ...
 const mpPlayers=Array.from({length:4},(_,i)=>({...snapshot.players[0],id:'mp'+i,name:['EDWARD','JAIME','RODRIGO','RICARDO'][i],handicap:[6,14,8,11][i]}));
 const mp=artifacts.build({...snapshot,mode:'match_play',players:mpPlayers,matchPlay:{resultLabel:'MATCH PLAY'}}).global.html;
