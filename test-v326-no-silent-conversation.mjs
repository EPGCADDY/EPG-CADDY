...
assert.equal(conversation.silence_duration_ms,275);
...
for(let turn=1;turn<=30;turn++){
  assert.equal(profiles.turnDetectionForProfile("conversation").silence_duration_ms,275,`Turno ${turn}: la conversación volvió a quedar sin tiempo determinista`);
