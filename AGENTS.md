...
10. Antes de trabajar desde otra conversación, sincronizar la rama canónica remota y conservar obligatoriamente los bancos V354–V358 de voz y V324/V337/V356 de tráfico-clima. No sustituir archivos completos con versiones de otra rama: cualquier cambio debe ser incremental, mantener `test-v357-ios-voice-transport-recovery.mjs` y `test-v358-ios-score-universal-physical-recovery.mjs`, y ejecutar la auditoría integral. Producción no se toca.
