...
11. Estado canónico de continuidad al 28 de agosto de 2026: V366 queda RECHAZADA por `IMG_2197.jpeg`/`IMG_2199.png`; la única línea autorizada para continuar es V367/RC-039 en `fix-final-universal-oidc`. Ninguna conversación puede presentar V366, su Preview o un enlace anterior como final, ni revertir la prioridad de `inicio=1` sobre una ronda persistida. Antes de cambiar o desplegar, comparar rama, árbol, ROADMAPS y registro RC-039 con la rama remota canónica.
