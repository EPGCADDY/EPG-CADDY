...
assert.match(html,/body\.gsc-setup-open:has\(#setupOverlay\.visible\) \.mandatory-update\{display:block!important\}/,"ACTUALIZAR debe permanecer visible en Registro");
