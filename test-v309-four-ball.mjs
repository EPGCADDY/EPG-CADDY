...
assert.match(html,/function fourBallPairBestRow/,"Debe existir una sola fila de mejor Neto por pareja");
assert.match(html,/MEJOR NETO · \$\{escapeHtml\(teamName\)\}/,"Fila de pareja debe identificar el mejor Neto");
