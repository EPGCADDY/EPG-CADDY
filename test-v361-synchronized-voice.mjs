...
assert.match(worker,/CACHE_NAME="gscg-mobile-[^"]*v380-three-turn-audio-release[^"]*v381-unified[^"]*v388-history-three-turn-batch-capture[^"]*v389-universal-runtime-availability[^"]*v390-physical-history-voice-recovery"/);
