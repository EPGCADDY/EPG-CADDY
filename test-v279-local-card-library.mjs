...
for(const id of ["openCardLibraryButton","openCardLibrarySetup","openCardLibraryStableford","cardLibraryOverlay","cardLibraryMode","cardLibraryCourse","cardLibraryQuery","cardLibraryList","cardLibraryPager","cardLibraryPrevious","cardLibraryNext","librarySendDigital"])assert.match(html,new RegExp(`id="${id}"`),`Falta ${id}`);
