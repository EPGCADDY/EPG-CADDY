...
**Recuperación V365 de locutor universal:** `IMG_2187.png` y los logs de Producción rechazaron el cierre V364: AI UNIVERSAL escuchó, transcribió y obtuvo 200, pero Cedar recibió 429, `/api/voice-speech` terminó 503 y Safari no encontró un nombre masculino español aprobado. V365 encadena Onyx directo `tts-1`, Gateway oficial `openai/tts-1` y locutor masculino local precargado/expandido. La prueba física audible en iPhone sigue siendo obligatoria antes de llamar definitivo al enlace.
