...
assert.ok(vercel.redirects.some(item=>item.source==="/manual.pdf"&&item.destination==="https://epg-caddy.vercel.app/manual.pdf"),"La ruta Support heredada debe abrir el PDF canónico");
