...
const expected='<a class="live-support-link" href="/manual.pdf" target="_blank" rel="noopener noreferrer" aria-label="Abrir el Manual de Usuario V407 R.18 de Golf Score Card GT">Support</a>';

assert.equal(html.split('class="live-support-link"').length-1,1,"Debe existir un solo enlace Support global");
assert.ok(html.includes(expected),"Support debe abrir el PDF exacto del Manual V407 R.18 en otra pestaña");
