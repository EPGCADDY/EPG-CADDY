...
const expected='<a class="live-support-link" href="/manual.html?__gscg_build_check=1" aria-label="Abrir el Manual interactivo de Golf Score Card GT en esta pantalla">Support</a>';

assert.equal(html.split('class="live-support-link"').length-1,1,"Debe existir un solo enlace Support global");
assert.ok(html.includes(expected),"Support debe abrir el Manual interactivo exacto en la misma pantalla");
