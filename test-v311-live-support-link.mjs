...
const expected='<a class="live-support-link" href="/manual-scg" target="_blank" rel="noopener noreferrer" aria-label="Abrir el Manual vivo de Golf Score Card GT">Support</a>';
