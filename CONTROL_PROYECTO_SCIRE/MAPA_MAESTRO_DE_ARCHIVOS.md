...
| `index-grupal.html` · V371-R3 | Salida universal Safari | Se calcula al publicar | Reproduce MP3 mexicano servidor y sólo acepta éxito audible desde `Audio.onplay`; Registro y Score quedan intocables. |
| `api/voice-speech.js` · V371-R3 | Voz universal | Se calcula al publicar | Onyx 0.90 con instrucciones de español mexicano neutro, sin Spanglish. |
| `test-v370-native-spanish-fast-close.mjs` · V371-R3 | Regresión de voz | Se calcula al publicar | Bloquea falso éxito sin `onplay`, ausencia del TTS servidor y caché R2. |
...
## V380 · continuidad Universal de tres turnos
