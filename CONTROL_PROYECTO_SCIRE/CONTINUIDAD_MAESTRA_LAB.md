...
## Continuidad V406-R25 · 8 de septiembre de 2026

La evidencia física `IMG_3076.png` acreditó `V406 · R24` blanco encima de ACTUALIZADO y mostró un defecto adicional: `05:31 P. M.` se superponía dentro del botón. R25 oculta únicamente el `timeText` duplicado en móvil; la hora permanece visible en la fila `INICIO`. No cambia scoring, voz, temporizador ni promoción manual. Auditoría completa: 122 paquetes PASS. Nueva revisión física publicada obligatoria; Producción intacta en `4009f79f50987f8bf105189bce9c5e90b2857363`.
