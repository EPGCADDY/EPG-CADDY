# V365 · recuperación de ronda activa · RC-036
...
La prueba automática no sustituye la reapertura física Safari/iPhone del Preview V365.

`test-v289-stableford-new-round-empty.mjs` confirma además que el Registro Stableford puede permanecer vacío sin convertirse en una ronda recuperable ni interferir con la tarjeta General activa.
