...
const successor=readFileSync(new URL("./candidate-index-grupal.html",import.meta.url),"utf8");
...
assert.match(successor,/data\.type==="PROMOTION_READY"/);
...
assert.doesNotMatch(worker,/install[\s\S]{0,300}promoteCandidate\(/,"La instalación del worker no puede promover R34 sin el toque del propietario");
