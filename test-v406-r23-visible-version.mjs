...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R24D<\/span><button type="button" id="mandatoryUpdateButton" aria-disabled="true" disabled/);
...
assert.match(worker,/const RELEASE="V407-R24D-MANUAL-UPDATE-20260910"/);
assert.doesNotMatch(worker,/install[\s\S]{0,300}promoteCandidate\(/,"La instalación del worker no puede promover R24D sin el toque del propietario");
