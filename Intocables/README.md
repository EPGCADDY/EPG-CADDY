...
3. AI UNIVERSAL conserva la voz V378 sellada: Fish Audio `fish-audio/s2.1-pro-free`, español `es-419`, velocidad autorizada `0.963`, sin ID fijo, acceso de un toque, watchdog y cierres progresivos hablados; toda consulta por voz responde audible sobre Inicio, Registro o tarjeta sin abrir otra pantalla. La aprobación auditiva del candidato permanece pendiente.
