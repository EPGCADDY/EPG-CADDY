...
3. Por orden del propietario del 18 de septiembre de 2026, AI UNIVERSAL unifica PCM y MP3 en TTS-1, voz fija `onyx`, velocidad `0.90`; aprobación audible pendiente. Conserva acceso de un toque, watchdog y cierres progresivos hablados; toda consulta por voz responde audible sobre Inicio, Registro o tarjeta sin abrir otra pantalla.
