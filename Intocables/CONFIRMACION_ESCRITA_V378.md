# CONFIRMACIÓN ESCRITA · V378 · REGISTRO Y SCORES INTOCABLES
...
Queda terminantemente prohibido modificar, reemplazar, reinterpretar o “mejorar” esas funciones sin una nueva orden expresa de Jaime Kirste. Seis regiones funcionales exactas quedan selladas por SHA-256 en `APROBACION_FISICA_REGISTRO_SCORES_V378.json`; cualquier cambio de un solo byte provoca `FAIL INTOCABLES` y bloquea auditoría, Preview y Producción.
...
La voz y su velocidad aprobadas físicamente tampoco pueden cambiarse. V390 restaura `api/voice-speech.js` byte por byte desde el commit V378 (`SHA-256 dd4597f6c60b0800adc990c7d99256ea5dfd13ac219b70292587718704ca5fee`) y el gate bloquea desde ahora cualquier diferencia del archivo completo. El ID de locutor agregado en V383 queda retirado porque cambió físicamente la voz sin autorización.
