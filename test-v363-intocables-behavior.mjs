...
const legacyIndex=html.indexOf('const candidates=[latestStoredRound("general"),latestStoredRound("stableford"),latestStoredRound("match_play"),latestStoredRound("four_ball")]');
