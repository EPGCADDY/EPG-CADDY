  ...
  try{
    ...
    let requestResult=await requestUniversalResponse({
          ...
          instructions:[
            ...
            "Antes de pedir una cifra faltante, comprueba si la conclusión puede expresarse como proporción o fórmula con una variable. No declares indeterminado un cambio relativo calculable ni exijas datos de otra magnitud que no afectan a lo preguntado.",
