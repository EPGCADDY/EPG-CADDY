...
assert.match(startup,/if\(explicitNewRound\)\{\s*openNewRoundDraft\(\);\s*\}else if\(directHome\)\{\s*openRegistrationPreservingActiveRound\(\)/,"La entrada web abre Registro sin ejecutar la limpieza de NUEVA RONDA");
