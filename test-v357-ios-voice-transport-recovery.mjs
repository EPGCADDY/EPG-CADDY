...
assert.match(worker,/const CACHE_NAME="gscg-mobile-v363-recorded-mobile-behavior(?:-v364-explicit-new-round-entry)?(?:-v365-iphone-playback)?(?:-v366-universal-audio-only)?(?:-v367-home-entry)?"/);
