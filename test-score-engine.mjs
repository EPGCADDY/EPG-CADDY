...
const courses=[
  ...
  {name:'Country Club',par:array('COUNTRY_CLUB_PAR'),matrices:[array('COUNTRY_CLUB_SI_BLUE'),array('COUNTRY_CLUB_SI_WHITE'),array('COUNTRY_CLUB_SI_WOMEN')]},
];
...
for(const {par:PAR,matrices} of courses){
...
console.log('PASS motor exhaustivo Gross/Neto/handicap: 2 campos, 5 matrices, HCP 0–54, 18 hoyos y 12 Gross');
