...
if(experimentalBranches.has(branch)){
  ...
  const allowedPaths=new Set(['api/release.js','middleware.js','service-worker.js','vercel.json','scripts/apply-update-e.mjs','update-client-e.js','index-grupal.html','candidate-index-grupal.html','scripts/roadmap-gate.mjs','.github/workflows/roadmap-gate.yml','.github/workflows/lab-mic-r42-hotfix.yml']);
