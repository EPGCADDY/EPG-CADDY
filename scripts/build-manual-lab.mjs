...
for(const test of ['test-owner-invitation-ui.mjs','test-manual-no-assistant.mjs','test-manual-startup-sharing.mjs','test-device-closures.mjs','test-score-engine.mjs','test-round-closure.mjs','test-player-registry.js','test-stableford.mjs','test-stableford-manual.mjs','test-v398-manual-opening-hole.mjs','test-v306-match-play.mjs','test-v309-four-ball.mjs','test-v329-skins.mjs','test-lab-account-gate.mjs','test-lab-user-shortcuts.mjs','test-lab-shortcuts-navigation.mjs','test-lab-edit-round-mode.mjs','test-card-artifacts.mjs','test-stableford-torneo.mjs','test-lab-navigation.mjs','test-v397-card-in-out-back-contract.mjs','test-lab-global-operational-audit.mjs'])execFileSync(process.execPath,[test],{stdio:'inherit'});
