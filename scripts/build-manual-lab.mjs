...
assert(html.includes('startRoundScoreDictation'),'Dedicated local score dictation missing');
assert(html.includes('window.SpeechRecognition||window.webkitSpeechRecognition'),'Score dictation must use browser speech recognition only');
