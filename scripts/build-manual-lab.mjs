...
for(const test of ['test-manual-startup-sharing.mjs','test-device-closures.mjs','test-score-engine.mjs','test-round-closure.mjs','test-player-registry.js','test-stableford.mjs','test-stableford-manual.mjs','test-v398-manual-opening-hole.mjs','test-v306-match-play.mjs','test-v309-four-ball.mjs','test-v329-skins.mjs'])execFileSync(process.execPath,[test],{stdio:'inherit'});
