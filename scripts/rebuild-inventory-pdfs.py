...
def write_lock(paths):
    ...
    payload = {
        "version": "V372-GATEWAY-REALTIME-STREAMING-INTOCABLES",
...
def main():
    ...
    print(f"INVENTORY_LOCK PASS version=V372-GATEWAY-REALTIME-STREAMING-INTOCABLES sources={json.loads(LOCK.read_text(encoding='utf-8'))['sourceFileCount']}")
