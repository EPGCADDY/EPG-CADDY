...
def markdown_pdf(source, target, title):
    ...
    story = [Spacer(1, 45 * mm), Paragraph(html.escape(title), cover), Paragraph("Fuente: candidato V372 STABLEFORD-LIVE-MIRROR integrado con V371-R7/V368, voz OIDC e INTOCABLES - Produccion intacta", ParagraphStyle("CoverSub", parent=base, alignment=TA_CENTER, fontSize=10)), PageBreak()]
...
def image_inventory_pdf(target):
    ...
    document.drawCentredString(A4[0] / 2, A4[1] - 70 * mm, "Base visual V292 + candidato V372 Stableford LIVE integrado con V371-R7/V368 e INTOCABLES")
    document.showPage()
...
def write_lock(paths):
    ...
    payload = {
        "version": "V372-STABLEFORD-LIVE-MIRROR-INTOCABLES",
...
def main():
    ...
    print(f"INVENTORY_LOCK PASS version=V372-STABLEFORD-LIVE-MIRROR-INTOCABLES sources={json.loads(LOCK.read_text(encoding='utf-8'))['sourceFileCount']}")
