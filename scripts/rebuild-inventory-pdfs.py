...
def write_lock(paths):
    ...
    payload = {
        "version": "V385-IOS-AUDIO-SESSION-AND-FULL-INPUT-LOCK",
...
def main():
    ...
    print(f"INVENTORY_LOCK PASS version=V385-IOS-AUDIO-SESSION-AND-FULL-INPUT-LOCK sources={json.loads(LOCK.read_text(encoding='utf-8'))['sourceFileCount']}")
