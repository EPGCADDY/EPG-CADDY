...
def markdown_pdf(source, target, title):
    ...
    story = [Spacer(1, 45 * mm), Paragraph(html.escape(title), cover), Paragraph("Fuente: candidato V375 FAST-UNIVERSAL-SENSITIVE-SCORE integrado con V374/V373/V371/V370/V369/V368, voz Gateway e INTOCABLES - Produccion intacta", ParagraphStyle("CoverSub", parent=base, alignment=TA_CENTER, fontSize=10)), PageBreak()]
...
def image_inventory_pdf(target):
    ...
    document.drawCentredString(A4[0] / 2, A4[1] - 70 * mm, "Base visual V292 + candidato V375 integrado con V374/V373/V371/V370/V369/V368, voz Gateway e INTOCABLES")
    document.showPage()
...
def write_lock(paths):
    ...
    payload = {
        "version": "V387-UNIFIED-V386-VOICE-HISTORY-STABLEFORD-WHATSAPP-CARD",
...
def main():
    ...
    print(f"INVENTORY_LOCK PASS version=V387-UNIFIED-V386-VOICE-HISTORY-STABLEFORD-WHATSAPP-CARD sources={json.loads(LOCK.read_text(encoding='utf-8'))['sourceFileCount']}")
