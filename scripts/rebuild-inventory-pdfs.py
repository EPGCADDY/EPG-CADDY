...
def write_lock(paths):
    ...
    payload = {
        "version": "V384-FULL-INPUT-CHAIN-LOCK-AND-FIXED-MALE-VOICE",
...
def main():
    ...
    print(f"INVENTORY_LOCK PASS version=V384-FULL-INPUT-CHAIN-LOCK-AND-FIXED-MALE-VOICE sources={json.loads(LOCK.read_text(encoding='utf-8'))['sourceFileCount']}")
