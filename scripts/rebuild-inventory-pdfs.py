...
def write_lock(paths):
    ...
    payload = {
        "version": "V371-R10-TURN-AUDIO-RESET-INTOCABLES",
...
def main():
    ...
    print(f"INVENTORY_LOCK PASS version=V371-R10-TURN-AUDIO-RESET-INTOCABLES sources={json.loads(LOCK.read_text(encoding='utf-8'))['sourceFileCount']}")
