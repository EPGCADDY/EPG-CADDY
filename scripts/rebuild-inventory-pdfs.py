...
def write_lock(paths):
    ...
    payload = {
        "version": "V371-MATCH-GROSS-MICROPHONE-LOCK",
...
def main():
    ...
    print(f"INVENTORY_LOCK PASS version=V371-MATCH-GROSS-MICROPHONE-LOCK sources={json.loads(LOCK.read_text(encoding='utf-8'))['sourceFileCount']}")
