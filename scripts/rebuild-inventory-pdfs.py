...
def write_lock(paths):
    ...
    payload = {
        "version": "V389-UNIVERSAL-RUNTIME-AVAILABILITY",
...
def main():
    ...
    print(f"INVENTORY_LOCK PASS version=V389-UNIVERSAL-RUNTIME-AVAILABILITY sources={json.loads(LOCK.read_text(encoding='utf-8'))['sourceFileCount']}")
