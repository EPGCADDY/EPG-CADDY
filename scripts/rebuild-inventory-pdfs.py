...
def write_lock(paths):
    ...
    payload = {
        "version": "V391-INTEGRATED-TECHNICAL-LOCK",
...
def main():
    ...
    print(f"INVENTORY_LOCK PASS version=V391-INTEGRATED-TECHNICAL-LOCK sources={json.loads(LOCK.read_text(encoding='utf-8'))['sourceFileCount']}")
