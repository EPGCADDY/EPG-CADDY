...
def markdown_pdf(source, target, title):
    ...
    story = [Spacer(1, 45 * mm), Paragraph(html.escape(title), cover), Paragraph("Fuente: candidato V374-R2 STREAMING-VOICE-AUTH integrado con V373/V371/V370/V369/V368, voz Gateway e INTOCABLES - Produccion intacta", ParagraphStyle("CoverSub", parent=base, alignment=TA_CENTER, fontSize=10)), PageBreak()]
...
def image_inventory_pdf(target):
    ...
    document.drawCentredString(A4[0] / 2, A4[1] - 70 * mm, "Base visual V292 + candidato V374-R2 integrado con V373/V371/V370/V369/V368, voz Gateway e INTOCABLES")
    document.showPage()
...
def write_lock(paths):
    ...
    payload = {
        "version": "V374-R2-STREAMING-VOICE-AUTH-INTOCABLES",
...
def main():
    ...
    print(f"INVENTORY_LOCK PASS version=V374-R2-STREAMING-VOICE-AUTH-INTOCABLES sources={json.loads(LOCK.read_text(encoding='utf-8'))['sourceFileCount']}")
