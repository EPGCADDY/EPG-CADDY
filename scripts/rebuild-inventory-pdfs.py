...
def write_lock(paths):
    ...
    payload = {
        "version": "V381-SERIAL-AUDIO-INPUT-RESET-AND-V378-LOCK",
...
def main():
    ...
    print(f"INVENTORY_LOCK PASS version=V381-SERIAL-AUDIO-INPUT-RESET-AND-V378-LOCK sources={json.loads(LOCK.read_text(encoding='utf-8'))['sourceFileCount']}")
