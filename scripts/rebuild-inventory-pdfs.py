...
def write_lock(paths):
    ...
    payload = {
        "version": "V394-IOS-MEDIARECORDER-FINAL-BLOB",
...
def main():
    ...
    print(f"INVENTORY_LOCK PASS version=V394-IOS-MEDIARECORDER-FINAL-BLOB sources={json.loads(LOCK.read_text(encoding='utf-8'))['sourceFileCount']}")
