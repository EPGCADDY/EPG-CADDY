...
def write_lock(paths):
    ...
    payload = {
        "version": "V396-THREE-TURN-SILENCE-EVIDENCE",
...
def main():
    ...
    print(f"INVENTORY_LOCK PASS version=V396-THREE-TURN-SILENCE-EVIDENCE sources={json.loads(LOCK.read_text(encoding='utf-8'))['sourceFileCount']}")
