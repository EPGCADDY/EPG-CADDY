...
def write_lock(paths):
    ...
    payload = {
        "version": "V386-UNIVERSAL-DIRECT-CAPTURE-AND-FULL-INPUT-LOCK",
...
def main():
    ...
    print(f"INVENTORY_LOCK PASS version=V386-UNIVERSAL-DIRECT-CAPTURE-AND-FULL-INPUT-LOCK sources={json.loads(LOCK.read_text(encoding='utf-8'))['sourceFileCount']}")
