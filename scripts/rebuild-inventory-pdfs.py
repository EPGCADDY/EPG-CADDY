...
def write_lock(paths):
    ...
    payload = {
        "version": "V375-FAST-UNIVERSAL-SENSITIVE-SCORE-INTOCABLES",
...
def main():
    ...
    print(f"INVENTORY_LOCK PASS version=V375-FAST-UNIVERSAL-SENSITIVE-SCORE-INTOCABLES sources={json.loads(LOCK.read_text(encoding='utf-8'))['sourceFileCount']}")
