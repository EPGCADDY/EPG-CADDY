...
def write_lock(paths):
    ...
    payload = {
        "version": "V381-UNIFIED-VOICE-HISTORY-STABLEFORD",
...
def main():
    ...
    print(f"INVENTORY_LOCK PASS version=V381-UNIFIED-VOICE-HISTORY-STABLEFORD sources={json.loads(LOCK.read_text(encoding='utf-8'))['sourceFileCount']}")
