...
def write_lock(paths):
    ...
    payload = {
        "version": "V395-IOS-MEDIARECORDER-SILENCE-CLOSE",
...
def main():
    ...
    print(f"INVENTORY_LOCK PASS version=V395-IOS-MEDIARECORDER-SILENCE-CLOSE sources={json.loads(LOCK.read_text(encoding='utf-8'))['sourceFileCount']}")
