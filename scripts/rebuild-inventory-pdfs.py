...
def write_lock(paths):
    ...
    payload = {
        "version": "V393-MANUAL-HOLE-UNIVERSAL-RESPONSE",
...
def main():
    ...
    print(f"INVENTORY_LOCK PASS version=V393-MANUAL-HOLE-UNIVERSAL-RESPONSE sources={json.loads(LOCK.read_text(encoding='utf-8'))['sourceFileCount']}")
