...
def write_lock(paths):
    ...
    payload = {
        "version": "V392-MEDIARECORDER-IN-FIRST",
...
def main():
    ...
    print(f"INVENTORY_LOCK PASS version=V392-MEDIARECORDER-IN-FIRST sources={json.loads(LOCK.read_text(encoding='utf-8'))['sourceFileCount']}")
