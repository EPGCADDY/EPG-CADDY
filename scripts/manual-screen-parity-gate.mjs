...
const manualWithoutRemovalNotice=manual.replace(/no existe entrada por micrófono para crear la ronda/gi,"FUNCIÓN RETIRADA").replace(/no hay entrada por micrófono/gi,"FUNCIÓN RETIRADA");
