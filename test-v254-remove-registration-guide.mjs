...
assert.match(html,/<div class="voice-prompt"><strong id="playerVoicePrompt">REGISTRO DE JUGADORES · CADDIE UNIVERSAL<\/strong><span>REGISTRA SÓLO A UNO O AL GRUPO · HASTA 6<\/span><\/div>/);
