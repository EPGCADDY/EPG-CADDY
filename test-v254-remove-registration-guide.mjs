...
assert.match(html,/<div class="voice-prompt"><strong id="playerVoicePrompt">REGISTRO DE JUGADORES · CADDIE UNIVERSAL<\/strong><span>REGISTRA O PREGUNTA CUALQUIER TEMA<\/span><\/div>/);
