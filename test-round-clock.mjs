...
assert.ok(html.includes('$("backToRegistrationButton").addEventListener("click",()=>demoControlManual?false:isStablefordRound()?openStablefordDataEditor():openCurrentRoundDataEditor())'),'ATRÁS debe editar o agregar datos de la ronda activa sin borrar scores y permanecer aislado en la demostración');
