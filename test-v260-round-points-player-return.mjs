...
assert.match(html,/\[primary,backup,stableford,matchPlay\]\.filter\(value=>playableStoredRound\(value\)&&mode\(value\)===modeHint\)\.sort/);
assert.match(html,/readRoundArchive\(\)\.filter\(value=>playableStoredRound\(value\)&&mode\(value\)===modeHint\)\.sort/);
