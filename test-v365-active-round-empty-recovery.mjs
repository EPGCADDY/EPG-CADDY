...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r4-ios-safe-area-header`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R4<\/span><button type="button" id="mandatoryUpdateButton"/);
...
assert.match(html,/meta name="gscg-release" content="V407-R4-IOS-SAFE-AREA-HEADER-20260908"/);
