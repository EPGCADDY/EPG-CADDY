...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r41-voice-start`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R41<\/span><button type="button" id="mandatoryUpdateButton" aria-disabled="true" disabled/);
...
assert.match(html,/meta name="gscg-release" content="V407-R41-PTT-HOLD-20260913"/);
