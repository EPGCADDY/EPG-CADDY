...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r8-single-scroll`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R8<\/span><button type="button" id="mandatoryUpdateButton" aria-disabled="false"/);
...
assert.match(html,/meta name="gscg-release" content="V407-R8-SINGLE-SCROLL-20260908"/);
