...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r32-open-conversation`/);
...
assert.match(html,/meta name="gscg-release" content="V407-R32-OPEN-CONVERSATION-20260913"/);
