...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v406-r16-live-handicap`/);
...
assert.match(html,/meta name="gscg-release" content="V406-R16-LIVE-HANDICAP-20260907"/);
