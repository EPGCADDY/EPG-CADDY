...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r33-visible-voice-errors`/);
assert.match(worker,/const APPROVED_CACHE_NAME=`\$\{CACHE_NAME\}-approved-digital-card-share`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R33<\/span><button type="button" id="mandatoryUpdateButton" aria-disabled="true" disabled/);
...
assert.match(html,/meta name="gscg-release" content="V407-R33-VISIBLE-VOICE-ERRORS-20260913"/);
