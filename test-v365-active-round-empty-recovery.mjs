...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r7-ios-scroll`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R7<\/span><button type="button" id="mandatoryUpdateButton"/);
...
assert.match(html,/meta name="gscg-release" content="V407-R7-IOS-SCROLL-20260908"/);
