...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r24d-manual-update`/);
...
assert.match(html,/meta name="gscg-release" content="V407-R24D-MANUAL-UPDATE-20260910"/);
