...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r34-audio-and-text`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R34<\/span><button type="button" id="mandatoryUpdateButton" aria-disabled="true" disabled/);
...
assert.match(html,/meta name="gscg-release" content="V407-R34-AUDIO-AND-TEXT-20260913"/);
