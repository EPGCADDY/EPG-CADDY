...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r40-ptt-hold`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R40<\/span><button type="button" id="mandatoryUpdateButton" aria-disabled="true" disabled/);
...
assert.match(html,/meta name="gscg-release" content="V407-R40-PTT-HOLD-20260913"/);
