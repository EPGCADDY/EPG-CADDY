...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r1-premium-visual-system`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R1<\/span><button type="button" id="mandatoryUpdateButton"/);
...
assert.match(html,/meta name="gscg-release" content="V407-R1-PREMIUM-VISUAL-SYSTEM-20260908"/);
