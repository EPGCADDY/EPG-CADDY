...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v406-r15-confirmed-clear-all`/);
...
assert.match(html,/meta name="gscg-release" content="V406-R15-CONFIRMED-CLEAR-ALL-20260907"/);
