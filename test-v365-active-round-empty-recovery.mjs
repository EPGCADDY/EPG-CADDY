...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r30-digital-card-share`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R30<\/span><button type="button" id="mandatoryUpdateButton" aria-disabled="true" disabled/);
...
assert.match(html,/meta name="gscg-release" content="V407-R30-DIGITAL-CARD-SHARE-20260913"/);
