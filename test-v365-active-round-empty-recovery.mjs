...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v406-r2-professional-design`/);
...
assert.match(html,/meta name="gscg-release" content="V406-R2-LAB-DESIGN-CANDIDATE-20260907"/);
