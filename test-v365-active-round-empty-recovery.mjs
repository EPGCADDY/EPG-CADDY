...
assert.match(worker,/const APPROVED_CACHE_NAME=`\$\{CACHE_NAME\}-approved-pulte-handicap-hotfix`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R28<\/span><button type="button" id="mandatoryUpdateButton" aria-disabled="true" disabled/);
