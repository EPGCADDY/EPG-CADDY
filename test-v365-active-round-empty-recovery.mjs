...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r38-push-to-talk`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R38<\/span><button type="button" id="mandatoryUpdateButton" aria-disabled="true" disabled/);
...
assert.match(html,/meta name="gscg-release" content="V407-R38-PUSH-TO-TALK-20260913"/);
