...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r22-active-round-live`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R22<\/span><button type="button" id="mandatoryUpdateButton" aria-disabled="true" disabled/);
...
assert.match(html,/meta name="gscg-release" content="V407-R22-ACTIVE-ROUND-LIVE-20260909"/);
