...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r29-digital-card`/);
...
assert.match(html,/meta name="gscg-release" content="V407-R29-DIGITAL-CARD-20260910"/);
