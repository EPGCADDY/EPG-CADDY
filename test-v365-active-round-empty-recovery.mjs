...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r24b-manual-recovery`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R24B<\/span><button type="button" id="mandatoryUpdateButton" aria-disabled="true" disabled/);
...
assert.match(html,/meta name="gscg-release" content="V407-R24B-MANUAL-RECOVERY-20260909"/);
