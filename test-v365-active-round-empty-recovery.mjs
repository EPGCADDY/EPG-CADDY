...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v406-r14-update-pulse-settles`/);
...
assert.match(html,/meta name="gscg-release" content="V406-R14-UPDATE-PULSE-SETTLES-20260907"/);
