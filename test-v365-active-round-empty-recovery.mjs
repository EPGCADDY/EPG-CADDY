...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r24-whatsapp-visual-manual`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R24<\/span><button type="button" id="mandatoryUpdateButton" aria-disabled="true" disabled/);
...
assert.match(html,/meta name="gscg-release" content="V407-R24-WHATSAPP-VISUAL-MANUAL-20260909"/);
