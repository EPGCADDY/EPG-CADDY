...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r10-active-update-button`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R10<\/span><button type="button" id="mandatoryUpdateButton" aria-disabled="false"/);
