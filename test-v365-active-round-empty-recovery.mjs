...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r39-ptt-voice-only`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R39<\/span><button type="button" id="mandatoryUpdateButton" aria-disabled="true" disabled/);
...
assert.match(html,/meta name="gscg-release" content="V407-R39-PTT-VOICE-ONLY-20260913"/);
