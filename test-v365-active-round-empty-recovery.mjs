...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r16-mode-selection`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R16<\/span><button type="button" id="mandatoryUpdateButton" aria-disabled="true" disabled/);
