...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v406-r5-simple-tournament-live`/);
...
assert.match(html,/meta name="gscg-release" content="V406-R5-SIMPLE-TOURNAMENT-LIVE-20260907"/);
