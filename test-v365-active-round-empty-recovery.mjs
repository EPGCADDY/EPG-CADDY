...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r6-universales`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R6<\/span><button type="button" id="mandatoryUpdateButton"/);
...
assert.match(html,/meta name="gscg-release" content="V407-R6-UNIVERSALES-20260908"/);
