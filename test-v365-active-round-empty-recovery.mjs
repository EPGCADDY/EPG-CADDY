...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r36-conversation`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R36<\/span><button type="button" id="mandatoryUpdateButton" aria-disabled="true" disabled/);
...
assert.match(html,/meta name="gscg-release" content="V407-R36-CONVERSATION-20260913"/);
