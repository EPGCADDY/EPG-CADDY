...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v406-r4-mobile-controls`/);
...
assert.match(html,/meta name="gscg-release" content="V406-R4-MOBILE-CONTROLS-20260907"/);
