...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v406-r24-visible-version-placement`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V406 · R24<\/span><button type="button" id="mandatoryUpdateButton"/);
...
assert.match(html,/meta name="gscg-release" content="V406-R24-VISIBLE-VERSION-PLACEMENT-20260908"/);
