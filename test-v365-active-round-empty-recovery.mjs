...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r15-remote-update-state`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R15<\/span><button type="button" id="mandatoryUpdateButton" aria-disabled="true" disabled/);
...
assert.match(html,/meta name="gscg-release" content="V407-R15-REMOTE-UPDATE-STATE-20260908"/);
