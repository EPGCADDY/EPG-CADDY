...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r21-support-access`/);
...
assert.match(html,/meta name="gscg-release" content="V407-R21-SUPPORT-ACCESS-20260909"/);
