...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r22-support-pdf`/);
...
assert.match(html,/meta name="gscg-release" content="V407-R22-SUPPORT-PDF-20260909"/);
