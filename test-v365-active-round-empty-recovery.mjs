...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v406-r6-tournament-demo-players`/);
...
assert.match(html,/meta name="gscg-release" content="V406-R6-TOURNAMENT-DEMO-PLAYERS-20260907"/);
