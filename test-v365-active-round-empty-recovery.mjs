...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v405-r2-registration-clear-mobile-card`/);
...
assert.match(html,/meta name="gscg-release" content="V405-R2-LAB-REGISTRATION-CLEAR-MOBILE-CARD-20260907"/);
