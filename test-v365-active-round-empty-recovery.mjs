...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r9-manual-update`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R9<\/span><button type="button" id="mandatoryUpdateButton" aria-disabled="true" disabled/);
