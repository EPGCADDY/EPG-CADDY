...
assert.match(worker,/const ACTIVE_CACHE_NAME=`\$\{CACHE_NAME\}-v407-r2-premium-scorecard-actions`/);
...
assert.match(html,/class="update-version-id" id="appVersionId">V407 · R2<\/span><button type="button" id="mandatoryUpdateButton"/);
...
assert.match(html,/meta name="gscg-release" content="V407-R2-PREMIUM-SCORECARD-ACTIONS-20260908"/);
