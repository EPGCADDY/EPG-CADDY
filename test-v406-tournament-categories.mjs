...
for(const label of ["CAMPEONATO","A","B","C","D","SENIOR","SUPER SENIOR","FEMENINA"])assert.ok(html.includes(label),`Falta ${label} en Registro`);
assert.match(html,/TOURNAMENT_PRELOAD_CATEGORIES=\{championship:"CAMPEONATO",a:"A",b:"B",c:"C",d:"D",senior:"SENIOR",super_senior:"SUPER SENIOR",female:"FEMENINA"\}/,"Registro debe precargar Campeonato A B C D Senior Super Senior Femenina");
...
assert.match(hubHtml,/<option value="championship">CAMPEONATO<\/option><option value="a">A<\/option><option value="b">B<\/option><option value="c">C<\/option><option value="d">D<\/option><option value="senior">SENIOR<\/option><option value="super_senior">SUPER SENIOR<\/option><option value="female">FEMENINA<\/option>/,"Centro de Torneos debe precargar las ocho categorías");
