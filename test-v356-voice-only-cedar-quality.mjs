...
assert.equal(gateway.language,undefined);
...
try{
  ...
  assert.equal(JSON.parse(calls[0].options.body).language,undefined);
...
console.log("PASS V356/V378 · configuración TTS-1/Onyx 0.90; audio físico no verificado; tráfico/clima estructurados");
