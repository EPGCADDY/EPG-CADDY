...
- middleware.js (únicamente para exponer /update-lab-d/ en esta rama experimental)

Reglas obligatorias:
1. Ningún archivo funcional de R33 puede modificarse durante el burn-in.
2. Sólo se permiten cambios bajo update-lab-d/, el gate experimental necesario y la excepción mínima de middleware.js para exponer /update-lab-d/.
