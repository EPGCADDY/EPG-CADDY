...
- La voz acepta nombre, hoyo y Gross numérico o expresión golfística. No reparte tiros de handicap. Al completar los hoyos 1–9 anuncia automáticamente la primera vuelta de cada jugador con Gross, Neto —igual a Gross porque Stableford es Scratch HCP 0— y resultado sobre/bajo par; el mismo formato se conserva al completar la segunda vuelta y la ronda.
