...
assert.match(html,/V407-R31-MOBILE-CARD-OUTLINE-20260910/);
...
assert.match(control,/if\(currentSnapshot\(\)\)return quickShareGroup\(\)/,"LIVE comparte directamente cualquier ronda activa sin pantalla intermedia");
