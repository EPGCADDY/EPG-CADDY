...
assert.match(html,/gscg-build" content="V(?:252-STABLEFORD-PERSISTENCE-CATEGORY-COURSE|253-LIVE-PREVIOUS-ROUND|254-REMOVE-REGISTRATION-GUIDE)-20260822"/);
for(const id of [
...
assert.match(html,/STABLEFORD_OFFICIAL_HOSTING_URL="https:\/\/epg-caddy-git-stableford-tournament-final-epgcaddys-projects\.vercel\.app\/index-grupal\.html\?stableford_emergency=countryclub&emergency_clean=1&v=254"/);
