...
assert.match(worker,/const RELEASE="V407-R15-REMOTE-UPDATE-STATE-20260908"/);
...
console.log("PASS V407-R15 · ACTUALIZAR parpadea sólo con versión nueva y se apaga al actualizar");
