...
for(const id of ["historyInsightsOverlay","historyInsightsQuery","runHistoryInsights","historyInsightsResult","closeHistoryInsights"])assert.match(html,new RegExp(`id="${id}"`),`Falta ${id}`);
assert.doesNotMatch(html,/id="openHistoryInsights"/,"Historial V397 no muestra la acción Estadísticas");
