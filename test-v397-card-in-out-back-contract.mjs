...
assert.match(html,/function releaseAiUniversalPlaybackForListening\(\)\{[\s\S]{0,700}aiUniversalTtsObjectUrl=""[\s\S]{0,100}return !!player/,"El micrófono principal debe conservar la liberación V378 antes de escuchar");
