...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r132`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r132`;
const RELEASE="LABORATORIO-20260925-R132";
