...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-lab-manual-invite-20260919`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-lab-manual-invite-approved-20260919`;
const RELEASE="LAB-MANUAL-INVITE-20260919";
