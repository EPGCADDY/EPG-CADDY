...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-production-r106-h2`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-production-r106-h2`;
const RELEASE="PRODUCTION-20260924-R106-H2";
