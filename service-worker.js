...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-production-r71`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-production-r71`;
const RELEASE="PRODUCTION-20260923-R71";
