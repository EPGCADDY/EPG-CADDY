...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r110`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r110`;
const RELEASE="LABORATORIO-20260925-R110";
