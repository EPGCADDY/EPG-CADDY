...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r125`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r125`;
const RELEASE="LABORATORIO-20260925-R125";
