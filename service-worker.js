...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-production-r106-h3`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-production-r106-h3`;
const RELEASE="PRODUCTION-20260924-R106-H3";
