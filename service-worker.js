...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r114`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r114`;
const RELEASE="LABORATORIO-20260925-R114";
