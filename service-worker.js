...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-lab-medal-monitor-r52`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-lab-medal-monitor-r52`;
const RELEASE="LAB-MEDAL-MONITOR-20260923-R52";
