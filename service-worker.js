...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-green-auto-advance-individual-audio-r13`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-lab-four-ball-team-nonumber-20260920-q`;
const RELEASE="GREEN-AUTO-ADVANCE-INDIVIDUAL-AUDIO-NO-SCORE-SPEECH-20260922-R13";
