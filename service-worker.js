...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-lab-keypad-correction-r48`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-lab-keypad-correction-r48`;
const RELEASE="LAB-KEYPAD-CORRECTION-20260922-R48";
