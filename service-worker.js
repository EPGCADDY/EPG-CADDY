...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r113`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r113`;
const RELEASE="LABORATORIO-20260925-R113";
