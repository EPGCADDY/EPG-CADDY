...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-lab-atajos-universal-logo-20260920-g`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-lab-atajos-universal-logo-approved-20260920-g`;
const RELEASE="LAB-ATAJOS-UNIVERSAL-LOGO-20260920-G";
