...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r129`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r129`;
const RELEASE="LABORATORIO-20260925-R129";
