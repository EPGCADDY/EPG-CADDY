...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r126`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r126`;
const RELEASE="LABORATORIO-20260925-R126";
