...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r133`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r133`;
const RELEASE="LABORATORIO-20260925-R133";
