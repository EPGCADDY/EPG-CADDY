...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r112`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r112`;
const RELEASE="LABORATORIO-20260925-R112";
