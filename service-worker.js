...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r115`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r115`;
const RELEASE="LABORATORIO-20260925-R115";
