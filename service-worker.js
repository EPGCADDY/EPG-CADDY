...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-production-r73`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-production-r73`;
const RELEASE="PRODUCTION-20260923-R73";
