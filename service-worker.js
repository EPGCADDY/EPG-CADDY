...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r107-h4`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r107-h4`;
const RELEASE="LABORATORIO-20260925-R107-H4";
