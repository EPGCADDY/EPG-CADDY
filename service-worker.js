...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r111`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r111`;
const RELEASE="LABORATORIO-20260925-R111";
