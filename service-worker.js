...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-visible-app-version-r41`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-visible-app-version-r41`;
const RELEASE="VISIBLE-APP-VERSION-20260922-R41";
