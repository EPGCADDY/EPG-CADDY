...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r121`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r121`;
const RELEASE="LABORATORIO-20260925-R121";
