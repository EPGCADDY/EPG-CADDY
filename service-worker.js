...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r116`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r116`;
const RELEASE="LABORATORIO-20260925-R116";
