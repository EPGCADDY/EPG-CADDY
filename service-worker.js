...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r127`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r127`;
const RELEASE="LABORATORIO-20260925-R127";
