...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-production-r105`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-production-r105`;
const RELEASE="PRODUCTION-20260924-R105";
