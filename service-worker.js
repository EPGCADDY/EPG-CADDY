...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-lab-tournaments-atajos-20260919-d`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-lab-tournaments-atajos-approved-20260919-d`;
const RELEASE="LAB-TOURNAMENTS-ATAJOS-20260919-D";
