...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r123`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r123`;
const RELEASE="LABORATORIO-20260925-R123";
