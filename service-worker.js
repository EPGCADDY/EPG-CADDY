...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-fixed-update-below-menu-r45`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-fixed-update-below-menu-r45`;
const RELEASE="FIXED-UPDATE-BELOW-MENU-20260922-R45";
