...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r108`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r108`;
const RELEASE="LABORATORIO-20260925-R108";
