...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r120`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r120`;
const RELEASE="LABORATORIO-20260925-R120";
