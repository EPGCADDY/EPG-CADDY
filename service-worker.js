...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-lab-tournaments-atajos-20260919-c`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-lab-tournaments-atajos-approved-20260919-c`;
const RELEASE="LAB-TOURNAMENTS-ATAJOS-20260919-C";
