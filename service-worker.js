...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r109`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r109`;
const RELEASE="LABORATORIO-20260925-R109";
