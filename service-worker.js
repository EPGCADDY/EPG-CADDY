"use strict";
// R146: iOS PWA network-first. Cache is fallback only; never pin an older application shell.
const RELEASE="LABORATORIO-20260925-R146";
const CACHE_NAME="gscg-mobile-v138-r146";
