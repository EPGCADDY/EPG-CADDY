"use strict";
// R145: iOS PWA network-first. Cache is fallback only; never pin an older application shell.
const RELEASE="LABORATORIO-20260925-R145";
const CACHE_NAME="gscg-mobile-v138-r145";
