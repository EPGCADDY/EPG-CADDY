...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r119`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r119`;
const RELEASE="LABORATORIO-20260925-R119";
