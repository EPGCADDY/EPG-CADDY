...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-production-r104`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-production-r104`;
const RELEASE="PRODUCTION-20260924-R104";
