...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-production-r72`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-production-r72`;
const RELEASE="PRODUCTION-20260923-R72";
