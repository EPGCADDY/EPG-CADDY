...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-player-name-button-click-audio-r26`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-player-name-button-click-audio-r26`;
const RELEASE="PLAYER-NAME-BUTTON-CLICK-AUDIO-20260922-R26";
