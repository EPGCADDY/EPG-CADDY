...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r128`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r128`;
const RELEASE="LABORATORIO-20260925-R128";
