...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-lab-manual-device-20260919`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-lab-manual-device-approved-20260919`;
const RELEASE="LAB-MANUAL-DEVICE-20260919";
