...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-version-badge-above-round-r42`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-version-badge-above-round-r42`;
const RELEASE="VERSION-BADGE-ABOVE-ROUND-20260922-R42";
