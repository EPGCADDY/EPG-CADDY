...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-remove-tournament-registration-move-players-20260921-af`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-lab-four-ball-team-nonumber-20260920-q`;
const RELEASE="REMOVE-TOURNAMENT-REGISTRATION-MOVE-PLAYERS-20260921-AF";
