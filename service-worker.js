...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r131`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r131`;
const RELEASE="LABORATORIO-20260925-R131";
