...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r117`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r117`;
const RELEASE="LABORATORIO-20260925-R117";
