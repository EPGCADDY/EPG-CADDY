...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r130`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r130`;
const RELEASE="LABORATORIO-20260925-R130";
