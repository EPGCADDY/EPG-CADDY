...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r118`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r118`;
const RELEASE="LABORATORIO-20260925-R118";
