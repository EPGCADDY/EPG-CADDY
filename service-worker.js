...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-lab-manual-clean-20260919`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-lab-manual-clean-approved-20260919`;
const RELEASE="LAB-MANUAL-CLEAN-20260919";
