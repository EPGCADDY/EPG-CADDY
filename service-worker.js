...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-auto-closure-playback-r40`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-auto-closure-playback-r40`;
const RELEASE="AUTO-CLOSURE-PLAYBACK-20260922-R40";
