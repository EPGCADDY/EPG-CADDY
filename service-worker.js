"use strict";
// R134 republish 2026-09-25: force installed LAB clients to re-fetch this worker and expose the manual update control.
...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r134`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r134`;
const RELEASE="LABORATORIO-20260925-R134";
