...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r124`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r124`;
const RELEASE="LABORATORIO-20260925-R124";
