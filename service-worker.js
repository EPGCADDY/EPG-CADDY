...
const ACTIVE_CACHE_NAME=`${CACHE_NAME}-laboratorio-r122`;
const APPROVED_CACHE_NAME=`${CACHE_NAME}-approved-laboratorio-r122`;
const RELEASE="LABORATORIO-20260925-R122";
